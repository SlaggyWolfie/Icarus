...
public class TubeRenderer : MonoBehaviour
{
    ...
    private Mesh _mesh;
    private bool _colliderExists = false;
    private bool _usingBumpmap = false;
    ...
    private void Start()
    {
        ...
        if (material != null && material.GetTexture("_BumpMap") != null) _usingBumpmap = true;
    }
    ...
    private void LateUpdate()
    {
        ...
        if (_usingBumpmap)
            _mesh.tangents = CalculateTangents(meshVertices);
        _mesh.uv = uvs;
